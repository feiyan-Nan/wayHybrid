...
window.Player = function (e) {
    ...
    return r(e, [{
      ...
      value: function (e) {
        var t = this,
          ...
          i = n.indexedDB.open(n.myDB.name, r);
        i.onerror = function (e) {}, i.onsuccess = function (r) {
      ...
      key: "addData",
      value: function (e, t) {
        for (var n = this.myDB.db.transaction(e, "readwrite").objectStore(e), r = void 0, i = 0; i < t.length; i++)(r = n.add(t[i])).onerror = function () {}, r.onsuccess = function () {}
      }
    }, {
      key: "putData",
      value: function (e, t) {
        for (var n = this.myDB.db.transaction(e, "readwrite").objectStore(e), r = void 0, i = 0; i < t.length; i++)(r = n.put(t[i])).onerror = function () {}, r.onsuccess = function () {}
      }
    }, {
      key: "getDataByKey",
      value: function (e, t, n) {
        var r = this,
          i = this.myDB.db.transaction(e, "readwrite").objectStore(e).get(t);
        i.onerror = function () {
          n.call(r, null)
  ...
  i = function () {
    ...
    var a = n.querySelector(".xgplayer-progress-played"),
      ...
      l = n.querySelector(".xgplayer-progress-point"),
      u = n.querySelector(".xgplayer-progress-thumbnail"),
      c = 0,
      p = 0,
      d = 0,
      f = 0,
    ...
    e.config.thumbnail && (c = e.config.thumbnail.pic_num, p = e.config.thumbnail.width, d = e.config.thumbnail.height, f = e.config.thumbnail.col, h = e.config.thumbnail.row, y = e.config.thumbnail.urls, u.style.width = p + "px", u.style.height = d + "px"), ["touchstart", "mousedown"].forEach(function (r) {
      n.addEventListener(r, function (r) {
        ...
        var s = a.getBoundingClientRect().left,
          u = function (n) {
            n.preventDefault(), n.stopPropagation(), t.event(n), e.isProgressMoving = !0;
            var r = n.clientX - s > o ? o : n.clientX - s,
              l = r / o * e.duration;
            if (a.style.width = 100 * r / o + "%", "video" === e.videoConfig.mediaType) e.currentTime = Number(l).toFixed(1);
            else {
      ...
      var i = n.getBoundingClientRect().left,
        ...
        a = function (n) {
          ...
          if (e.config.thumbnail) {
            ...
            var v = s + 1 - f * h * (Math.ceil((s + 1) / (f * h)) - 1),
              m = Math.ceil(v / h) - 1,
              x = v - m * h - 1;
  ...
  r.default.install("fullscreen", function () {
    ...
    i.appendChild(u);
    s.appendChild(i), ["click", "touchend"].forEach(function (r) {
